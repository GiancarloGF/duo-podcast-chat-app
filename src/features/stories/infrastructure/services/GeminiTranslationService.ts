...
Output JSON format.`;
  ...
  async getDetailedWordDefinition(
    ...
    const schema = z.object({
      definedWord: z.string().describe('The word or phrasal verb being defined'),
      partOfSpeech: z.string(),
      spanishTranslation: z.string().describe('The Spanish translation of the word or phrase in this context'),
      ...
      otherExamples: z.array(z.string()).describe('2-3 other sentences using this word/phrase'),
      summary: z.string().describe('Explanation of usage in this specific context'),
    });
