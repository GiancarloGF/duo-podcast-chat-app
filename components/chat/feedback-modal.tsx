...
export function FeedbackModal({ translation, onClose, isOpen }: FeedbackModalProps) {
    ...
    <div className="fixed inset-0 bg-black/50 dark:bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-900 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-slate-700 sticky top-0 bg-white dark:bg-slate-900">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Feedback de tu Traducción</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <span className="font-semibold text-gray-900 dark:text-white">Puntuación</span>
              <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">{feedback.score}/100</span>
            </div>
          </div>

          {/* Official Translation */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Traducción Oficial</h3>
          ...
          {/* User Translation */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Tu Traducción</h3>
          ...
          {/* Analysis */}
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Análisis</h3>
          ...
          {feedback.differences && (
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Diferencias</h3>
              <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg text-gray-900 dark:text-gray-100 text-sm">
                {feedback.differences}
              </div>
            </div>
          )}
          ...
          {feedback.suggestions && feedback.suggestions.length > 0 && (
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3">Sugerencias de Mejora</h3>
